...
export default function Service() {
  return (
    <section className="px-4 py-20 bg-gray-50" id="service">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 px-4 md:py-10 md:px-10">
        ...
        <div className="relative p-10 bg-white flex gap-x-4 rounded-2xl">
          ...
          <div>
            <FaCarBurst className="w-14 h-14 text-primary p-2 bg-primary/10 rounded-full mb-4" />
            <div>
        ...
        <div className="relative p-10 bg-white flex gap-x-4 rounded-2xl">
          ...
          <div>
            <RiVipCrownFill className="w-14 h-14 text-primary p-2 bg-primary/10 rounded-full mb-4" />
            <div>
        ...
        <div className="relative p-10 bg-white flex gap-x-4 rounded-2xl">
          ...
          <div>
            <MdOutlineSpeed className="w-14 h-14 text-primary p-2 bg-primary/10 rounded-full mb-4" />
            <div>
        ...
        <div className="relative p-10 bg-white flex gap-x-4 rounded-2xl">
          ...
          <div>
            <BsShieldCheck className="w-14 h-14 text-primary p-2 bg-primary/10 rounded-full mb-4" />
            <div>
        ...
        <div className="relative p-10 bg-white flex gap-x-4 rounded-2xl">
          ...
          <div>
            <IoLocationOutline className="w-14 h-14 text-primary p-2 bg-primary/10 rounded-full mb-4" />
            <div>
